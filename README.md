...
[![Version: 0.24.0](https://img.shields.io/badge/Version-0.24.0-blue.svg)](CHANGELOG.md)
...
- **Layer 1 = glintfx:** the C++ library documented here. **Released and the repository's active product** (tag `v0.18.0`).
...
- **Camada 1 = glintfx:** a biblioteca C++ documentada aqui. **Lançada e é o produto ativo deste repositório** (tag `v0.18.0`).
