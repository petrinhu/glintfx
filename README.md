...
> **Current release: v0.5.0** (stable, tagged), 2026-07-07. Full history in [`CHANGELOG.md`](CHANGELOG.md). Battle-tested by a real consumer (GusWorld, an SDL3 game) across the releases below.
...
> **Lançamento atual: v0.5.0** (estável, taggeada), 2026-07-07. Histórico completo em [`CHANGELOG.md`](CHANGELOG.md). Testada na prática por um consumidor real (GusWorld, um jogo SDL3) ao longo das versões abaixo.
