...
[![Version: 0.23.0](https://img.shields.io/badge/Version-0.23.0-blue.svg)](CHANGELOG.md)
...
- **CI ativo (GitHub Actions, o único gate de release).** A suíte completa de 99 testes (GLFW=ON) e a suíte embed de 70 testes (GLFW=OFF), mais os gates de lint/scan e cobertura, rodam em todo push/PR via `.github/workflows/ci.yml`. Um cron noturno de ASan (`.github/workflows/nightly.yml`) roda como rede de segurança independente. A perna mais profunda de ASan/LSan/UBSan e o job de regressão do motor de fonte próprio rodavam num runner self-hosted aposentado em 2026-07-25; estão **temporariamente sem casa em servidor nenhum** até um runner self-hosted ser montado no GitHub. Enquanto isso, reproduza essa classe de falha localmente com o `tools/ci/build_image.sh`.
