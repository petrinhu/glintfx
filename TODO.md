...
| L1.13-VPORIGIN | LW9 | C++23/API | `set_viewport(x,y,w,h,target_h)` (UiLayer-only) -- origem de composição configurável (GAP-2 ativado), ADR-0008 atualizado | Alta | L1.11-CLICKCB, L1.12-ELEMBOX | Média | ✅ Concluído | ✓ |
