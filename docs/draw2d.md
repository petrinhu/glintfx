...
`draw_sprite()` / `destroy_texture()` (`glintfx/src/draw2d.cpp:499`/`446`) reject a handle whose
...
`draw_sprite()` / `destroy_texture()` (`glintfx/src/draw2d.cpp:499`/`446`) rejeitam um handle cuja
