...
returned handle with the emitting instance's identity (`glintfx/src/draw2d.cpp:442`); both
`draw_sprite()` / `destroy_texture()` (`glintfx/src/draw2d.cpp:510`/`455`) reject a handle whose
...
retornado com a identidade da instância emissora (`glintfx/src/draw2d.cpp:442`); tanto
`draw_sprite()` / `destroy_texture()` (`glintfx/src/draw2d.cpp:510`/`455`) rejeitam um handle cuja
