...
// EN: SystemClock is header-only (inline implementation). This TU exists so the translation
//     unit owns the vtable and avoids weak-symbol duplication across object files.
