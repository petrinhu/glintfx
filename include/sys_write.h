...
//     functions layered on top of syscall0..6"). Mirrors POSIX write(): writes up to `count`
...
//     funcoes finas por cima" das syscall0..6). Espelha o write() POSIX: escreve ate `count`
