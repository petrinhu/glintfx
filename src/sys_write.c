...
// PT: sys_write -- ver include/sys_write.h pro contrato. Implementado como um wrapper de 1
//     linha sobre syscall3(SYS_write, fd, buf, count) (B3/ADR-0001): toda a logica de
